...
/**
 * com.paran.animation.demo.app.animation.PathButton.java - Creation date: 2011.
 * 12. 22. <br>
...
public class PathButton extends Button {
	...
	public void getHitRect(Rect outRect) {
	    ...
	    Log.e(TAG,"botton" +  outRect.bottom );
	    Log.e(TAG,"botton" +  outRect.top );
	    Log.e(TAG,"botton" +  outRect.top );
