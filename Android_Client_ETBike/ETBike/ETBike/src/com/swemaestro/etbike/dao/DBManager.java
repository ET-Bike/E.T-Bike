...
//				al.add(new MyBikeItem(Variable.KOR_SHARE_TYPE_DONATION, MyProfileActivity.VIEW_TYPE_SEPARATOR));
////				al.add(new MyBikeItem(cursor.getString(0), cursor.getString(1), cursor.getString(2), cursor.getString(3), cursor.getString(4), cursor.getString(5), cursor.getString(6), cursor.getString(7), cursor.getString(8), cursor.getString(9), cursor.getString(10), MyProfileActivity.VIEW_TYPE_MY_BIKE));
...
//				al.add(new MyBikeItem(Variable.KOR_SHARE_TYPE_RENT, MyProfileActivity.VIEW_TYPE_SEPARATOR));
//				cursor = getMyBikeCursor(Variable.KOR_SHARE_TYPE_RENT);
//				cursor.moveToFirst();
//				while(cursor.moveToNext()) {
//					al.add(new MyBikeItem(cursor.getString(0), cursor.getString(1), cursor.getString(2), cursor.getString(3), cursor.getString(4), cursor.getString(5), cursor.getString(6), cursor.getString(7), cursor.getString(8), cursor.getString(9), cursor.getString(10), MyProfileActivity.VIEW_TYPE_MY_BIKE));
//				}
//			}if(i == WorkVectors.SHARE_TYPE_SELL) {
//				al.add(new MyBikeItem(Variable.KOR_SHARE_TYPE_SELL, MyProfileActivity.VIEW_TYPE_SEPARATOR));
...
//		String query  = "inset into mybike values(" + mbi.myImagePath + "," + mbi.bikeImagePath + "," + mbi.bikeType + ","+mbi.tradeType + "," + mbi.shareType + "," + mbi.lati + "," + mbi.longi + "," + mbi.costPerTime + "," + mbi.costPerDay + "," + mbi.costPerWeek + "," + mbi.content +");";
//		
