...
public class MyBikeBoard {
	...
	public MyBikeBoard(int strMyImgResource, String writer, String content, String strBikeImagePath, int likeCount,int repliesCount) {
	
		this.strMyImgResource = strMyImgResource;
		this.writer = writer;
	...
	public int getStrMyImgResource() {
		return strMyImgResource;
	}
	public void setStrMyImgResource(int strMyImgResource) {
		this.strMyImgResource = strMyImgResource;
	}
	...
	public MyBikeBoard(String strBikeImageThumbPath, String content,
			String tradeType, String shareType) {
