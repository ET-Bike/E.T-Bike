...
public class LoginActivity extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		findViewById(R.id.loginBtnLogin).setOnClickListener(
				new OnClickListener() {
	...
	private void login() {
		...
		mFaceBook.authorize2(this,
				new String[] { "publish_stream, user_photos, email" }, al);
...
class AuthorizeListener implements DialogListener {
	...
	// 11-10 18:10:51.600: E/NetworkManager(18305): downlaod image url =
	// https://graph.facebook.com/100001290958599/picture
